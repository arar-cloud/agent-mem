...
A **mode** is a configuration profile defining four key aspects:

| Aspect | Purpose | Example |
|--------|---------|----------|
| **Observer Role** | How Claude analyzes work | "Software Engineer" vs. "Forensic Analyst" |
| **Observation Types** | Valid memory categories | "Bug Fix", "Feature", "Person", "Organization" |
| **Concepts** | Semantic indexing tags | "Pattern", "Trade-off", "Risk" |
| **Language** | The language used for generating observations and summaries.
